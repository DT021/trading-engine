...
func (b *SimulatedBroker) checkOrderExecutionOnTick(orderSim *SimBrokerOrder, tick *marketdata.Tick) event {
...
func (b *SimulatedBroker) checkOnTickLimit(order *SimBrokerOrder, tick *marketdata.Tick) event {
